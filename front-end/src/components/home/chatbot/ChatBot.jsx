...
const Chatbot = () => {
    ...
    const handleSendMessage = async () => {
        if (inputValue.trim() !== "") {
            ...
            await generateBotRepsonse([
                ...messages,
                {
                    role: userMessage.role,
                    position: userMessage.position,
                    type: "text",
                    text: `Using only details provided above, act as a friendly assistant and answer to this query from the user: ${userMessage.text}`,
