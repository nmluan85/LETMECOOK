        ...
        <div className="bg-gray-900 text-white py-12">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <input
                        ...
                        className="w-full py-2 px-4 rounded-full mb-4"
                    />
                    <button className="bg-blue-600 py-2 px-4 rounded-full w-full">
                        Send
                    </button>
                </div>
                <div>
            ...
            <div className="text-center mt-8">
                ...
                <p className="text-gray-400">
                    2024 Chefify Company | Terms of Service | Privacy Policy
                </p>
            </div>
            <div className="text-center mt-4">
                <p className="text-gray-400">
                    Made with{" "}
                    <img
                        src="https://www.visily.ai/wp-content/uploads/2022/04/Visily-Water-Mark-Framed-Logo@4x.png"
                        alt="Visily"
