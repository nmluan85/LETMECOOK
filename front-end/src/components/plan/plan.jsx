    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 shadow-md w-[1000px] max-w-[90%]">
                <h2 className="text-2xl font-bold mb-4 text-primary-500">{type === 'edit' ? 'Edit Plan' : 'Create A New Plan'}</h2>
                <div className="flex flex-wrap gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            placeholder="Recipe"
                            className="w-full border border-gray-300 rounded-md p-2"
                            value={events?.extendedProps.recipe ? events.extendedProps.recipe : ""}
                            onChange={(e) =>
                            setEvents({
                                ...events,
                                extendedProps: { ...events.extendedProps, recipe: e.target.value },
                            })
                            }
                        />
                        </label>
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            if (new Date(endTime) > new Date(events.start)) {
                ...
                <AddIngredient
                    ingre={events?.extendedProps.ingredients ? events.extendedProps.ingredients : []}
                    listIngredients={(updateIngredients) => {
                        setEvents({...events, extendedProps: {...events.extendedProps, ingredients: updateIngredients}})}}
                />
